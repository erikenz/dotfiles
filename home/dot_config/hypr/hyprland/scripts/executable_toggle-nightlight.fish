...
if test "$CURRENT_TEMP" = "$OFF_TEMP"
    ...
    caelestia shell toaster info "Screen temperature" "Screen temperature set to Nightlight" ""
    restart_nightlighted_waybar
else
    hyprctl hyprsunset temperature $OFF_TEMP
    caelestia shell toaster info "Screen temperature" "Screen temperature set to Daylight" ""
