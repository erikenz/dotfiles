...
hl.bind(mainMod .. " + CONTROL + Escape", hl.dsp.exec_cmd(noctCall .. " sessionMenu toggle"),
    { desc = "Toggle system power/session menu" })
...
hl.bind(mainMod .. " + P", hl.dsp.exec_cmd(noctCall .. "plugin:screen-toolkit colorPicker"),
    { desc = "Screen color picker tool" })
hl.bind("Print", hl.dsp.exec_cmd(noctCall .. "plugin:screen-toolkit annotate"),
    { desc = "Take screenshot & annotate area" })
hl.bind(mainMod .. " + Print", hl.dsp.exec_cmd(noctCall .. "plugin:screen-toolkit annotateWindow"),
    { desc = "Take screenshot & annotate window" })
hl.bind(mainMod .. " + R", hl.dsp.exec_cmd(noctCall .. "plugin:screen-toolkit toggle"), { desc = "Screen recorder tool" })
hl.bind(mainMod .. " + CONTROL + SHIFT + O", hl.dsp.exec_cmd(noctCall .. "plugin:screen-toolkit ocr"),
    { desc = "Extract text from screen (OCR)" })
hl.bind(mainMod .. " + SHIFT + Q", hl.dsp.exec_cmd(noctCall .. "plugin:screen-toolkit qr"),
    { desc = "Scan QR code from screen" })
hl.bind(mainMod .. " + CONTROL + M", hl.dsp.exec_cmd(noctCall .. "plugin:screen-toolkit measure"),
    { desc = "Screen measuring ruler tool" })

-- Theming and Wallpaper
hl.bind(mainMod .. " + CONTROL + SHIFT + W", hl.dsp.exec_cmd(noctCall .. " wallpaper toggle"),
    { desc = "Toggle desktop wallpaper menu" })
...
hl.bind(mainMod .. " + A", hl.dsp.exec_cmd(noctCall .. "notifications toggleHistory"),
    { desc = "Toggle notifications history panel" })
