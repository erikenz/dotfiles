...
Item {
    ...
    MaterialIcon {
        ...
        anchors {
            verticalCenter: network.verticalCenter
            left: network.right
            leftMargin: Appearance.spacing.smaller / 2
        }
    ...
    Row {
        ...
        // anchors.topMargin: Appearance.spacing.smaller / 2
        anchors {
            verticalCenter: bluetooth.verticalCenter
    ...
    MaterialIcon {
        ...
        // anchors.topMargin: Appearance.spacing.smaller / 2
        anchors {
            verticalCenter: devices.verticalCenter
            left: repeater.count > 0 ? devices.right : bluetooth.right
            leftMargin: Appearance.spacing.smaller / 2
        }
