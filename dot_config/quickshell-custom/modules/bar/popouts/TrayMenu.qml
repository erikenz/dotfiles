    ...
    component SubMenu: Column {
        ...
        Repeater {
            ...
            StyledRect {
                ...
                implicitHeight: Config.bar.sizes.trayMenuWidth
                ...
                Loader {
                    ...
                    sourceComponent: Item {
                        ...
                        StyledText {
                            ...
                            anchors {
                                top: icon.bottom
                                topMargin: icon.active ? Appearance.spacing.smaller : 0
                            }
        ...
        Loader {
            ...
            sourceComponent: Item {
                ...
                implicitWidth: back.implicitWidth + Appearance.padding.smaller / 2
